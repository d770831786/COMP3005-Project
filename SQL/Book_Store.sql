...
INSERT INTO "ordered" VALUES (2, 'admin');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "store" VALUES ('tom', 'admin');
...
-- ----------------------------
BEGIN;
INSERT INTO "user" VALUES ('admin', 'admin', 'Nicolas', 'El-Khoury', 4, 'admin@gmail.com', 6132405900, 'm', 20);
